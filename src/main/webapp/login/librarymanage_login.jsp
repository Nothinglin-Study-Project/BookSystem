...
<div class="ui grid">
    ...
    <div class="three wide column stackable grid border-right">
        ...
        <div class="column margin-bottom-10">
            <a href="login?actionName=librarymanageLogin" class="ui blue button item width-185">
                图书管理员登录
            </a>
        </div>
        <div class="column margin-bottom-10">
    ...
    <div class="eleven wide column">
        <form action="login" method="post">
            ...
            <input type="hidden" name="actionName" value="bookManegeLogin">
            <div class="ui container background-color-lightgray border-radius-5">
                ...
                <div class="ui right labeled input margin-top-10 margin-left-10">
                    ...
                    <input type="text" placeholder="请输入账号..." name="bookManegeName">
                </div>
                ...
                <div class="ui right labeled input margin-top-10  margin-left-10">
                    ...
                    <input type="password" placeholder="请输入密码..." name="bookManegePassword">
                </div>
                <br>
